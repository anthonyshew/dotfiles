...
It's likely that this setup is macOS dependent in ways I don't realize.

> [!NOTE]
> I haven't had the chance to use this from scratch. I don't know how well it works from zero.
> I'm not aware of dependencies that aren't captured in this repo, for instance.
